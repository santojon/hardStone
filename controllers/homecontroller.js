        ...
        getContent: () => {
            ...
            homeContent.sections.forEach((sec) => {
                ...
                // image in the left side
                    ...
                    res.push('<div class="col-sm-12 col-md-6 col-lg-8">')
                    sec.paragraphs.forEach((p) => {
                        res.push('<p class="hs_sec_p_r col-sm-12 col-md-12 col-lg-12">' + p + '</p>')
                    })
                    res.push('</div>')
                }
                res.push('</div>')
